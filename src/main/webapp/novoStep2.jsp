                ...
                <div class="sw sw-theme-basic sw-justified">
                    <div class="tab-content">
                        <div class="tab-pane" style="display: block">
                            <c:if test="${not empty PEDIDO.justificativaDiscente}">
                            ...
                            <div class="form-floating mb-3">
                                ...
                                <p class="form-control" id="nomeDiscente" readonly>${PEDIDO.discente.getNome()}</p>
                            </div>
                            <div class="form-floating mb-3">
                                <label for="matriculaDiscente">Matrícula</label>
                                <p class="form-control" id="matriculaDiscente" readonly>${PEDIDO.discente.getMatricula()}</p>
                            </div>
                            <div class="form-floating mb-3">
                                <label for="iraDiscente">IRA</label>
                                <p class="form-control" id="iraDiscente" readonly>${PEDIDO.discente.getIra()}</p>
                            </div>
                            <div class="form-floating mb-3">
                                <label for="periodoDiscente">Período</label>
                                <p class="form-control" id="periodoDiscente" readonly>${PEDIDO.discente.getPeriodo()}</p>
                            </div>
                            <div class="form-floating mb-3">
                                <label for="cargaHorariaCumpridaDiscente">Carga Horária Cumprida</label>
                                <p class="form-control" id="cargaHorariaCumpridaDiscente" readonly>${PEDIDO.discente.getCargaHorariaCumprida()}</p>
                            </div>
                            <div class="form-floating mb-3">
                                <label for="selectCursoDiscente">Curso</label>
                                <p class="form-control" id="selectCursoDiscente" readonly>${PEDIDO.discente.curso.getNome()}</p>
                            </div>
                            <div class="form-floating mb-3">
                                <label for="historicoDiscente">Visualizar o Histórico Acadêmico:</label>
                                <a id="historicoDiscente" href="${HISTORICO_ACADEMICO_URL}">${HISTORICO_ACADEMICO.nome}</a>
                            </div>
                            <div class="form-floating mb-3">
                                <label for="gradeHorarioDiscente">Visualizar a Grade de Horário:</label>
                                <a id="gradeHorarioDiscente" href="${GRADE_HORARIO_URL}">${GRADE_HORARIO.nome}</a>
                            </div>
                            <form class="needs-validation" novalidate accept-charset="utf-8" id="docenteForm" name="docenteForm" action="docenteController" method="post">
                                ...
                                <div role="toolbar" style="text-align: right">
                                    <button class="btn btn-primary" type="submit" id="submitButtonDocenteAnalisaNovoPedido1" name="submitButtonDocenteAnalisaNovoPedido1" value="step1">Enviar</button>
                                </div>
                            </form>
                        </div>
                    </div>
