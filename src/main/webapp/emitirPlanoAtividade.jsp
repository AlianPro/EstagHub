                        ...
                        <div class="tab-pane" style="display: block">
                            <c:choose>
                                <c:when test="${'NOVO_STEP4_PLANO_ATIVIDADES'== NOVO_ESTAGIO.status.name() || 'NOVO_STEP4_ATIVIDADES_TCE'== NOVO_ESTAGIO.status.name()}">
                                    <form class="needs-validation" enctype="multipart/form-data" novalidate id="discenteForm" name="discenteForm" action="discenteController" method="post">
                                        ...
                                        <div class="form-floating mb-3">
                                            ...
                                            <div class="invalid-feedback">
                                                Ops! Informe a Descrição da Terceira Atividade.
                                            </div>
                                        </div>
                                        <div class="form-floating mb-3">
                                            ...
                                            <div class="invalid-feedback">
                                                Ops! Informe a Descrição da Quarta Atividade.
                                            </div>
                                        </div>
                                        <div class="form-floating mb-3">
                                            ...
                                            <div class="invalid-feedback">
                                                Ops! Informe a Descrição da Quinta Atividade.
                                            </div>
                                        </div>
                                ...
                                <div class="form-floating mb-3">
                                    ...
                                    <input class="form-control" id="primeiraAtividade" type="text" name="primeiraAtividade" required placeholder="Descrição da Atividade"/>
                                    <div class="valid-feedback">
                                        Perfeito!
                                    </div>
                                    <div class="invalid-feedback">
                                ...
                                <div class="form-floating mb-3">
                                    ...
                                    <input class="form-control" id="segundaAtividade" type="text" name="segundaAtividade" required placeholder="Descrição da Atividade"/>
                                    <div class="valid-feedback">
                                        Perfeito!
                                    </div>
                                    <div class="invalid-feedback">
                                ...
                                <div class="form-floating mb-3">
                                    ...
                                    <input class="form-control" id="terceiraAtividade" type="text" name="terceiraAtividade" required placeholder="Descrição da Atividade"/>
                                    <div class="valid-feedback">
                                        Perfeito!
                                    </div>
                                    <div class="invalid-feedback">
                                ...
                                <div class="form-floating mb-3">
                                    ...
                                    <input class="form-control" id="quartaAtividade" type="text" name="quartaAtividade" required placeholder="Descrição da Atividade"/>
                                    <div class="valid-feedback">
                                        Perfeito!
                                    </div>
                                    <div class="invalid-feedback">
                                ...
                                <div class="form-floating mb-3">
                                    ...
                                    <input class="form-control" id="quintaAtividade" type="text" name="quintaAtividade" required placeholder="Descrição da Atividade"/>
                                    <div class="valid-feedback">
                                        Perfeito!
                                    </div>
                                    <div class="invalid-feedback">
