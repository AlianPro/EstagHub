                        ...
                        <div class="tab-pane" style="display: block">
                            <form class="needs-validation" novalidate id="docenteForm" name="docenteForm" action="docenteController" method="post">
                                ...
                                <div role="toolbar" style="text-align: right">
                                    <button class="btn btn-primary" type="submit" id="submitButtonDocenteCadastroDepartamento" name="submitButtonDocenteCadastroDepartamento" value="novoDepartamento">Enviar</button>
                                </div>
                            </form>
                        </div>
                    </div>
