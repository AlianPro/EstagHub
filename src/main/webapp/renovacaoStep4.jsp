                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <c:choose>
                                                            <c:when test="${'NOVO_STEP1' == pedido.status.name()}">
                                                                <a href="novoStep2.jsp" class="btn btn-primary" onclick="sendNextPage(${pedido.id}, '${pedido.status.name()}')">Avançar</a>
                                                            </c:when>
                                                            <c:when test="${'NOVO_STEP2' == pedido.status.name()}">
                                                                <a href="emitirTCE.jsp" class="btn btn-primary" onclick="sendNextPage(${pedido.id}, '${pedido.status.name()}')">Avançar</a>
                                                            </c:when>
                                                            <c:when test="${'NOVO_STEP3' == pedido.status.name()}">
                                                                <a href="novoStep4.jsp" class="btn btn-primary" onclick="sendNextPage(${pedido.id}, '${pedido.status.name()}')">Avançar</a>
                                                            </c:when>
                                                        </c:choose>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col">
                                                <div class="card" style="text-align: center">
                                                    <div class="card-body">
                                                        ...
                                                        <p class="card-text">${pedido.discente.getNome()}</p>
                                                        <c:choose>
                                                            <c:when test="${'RENOVACAO_STEP1' == pedido.status.name()}">
                                                                <a href="novoStep2.jsp" class="btn btn-primary" onclick="sendNextPage(${pedido.id}, '${pedido.status.name()}')">Avançar</a>
                                                            </c:when>
