...
<head>
    ...
    <script>
        $(document).ready(function (){
            $("#submitButtonSupervisorAvaliacao").click(function (){
                let formLogin = document.getElementById('supervisorForm');
                if(formLogin) {
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <!-- Page Heading -->
                <h1 class="h3 mb-4 text-gray-800">Avaliar Desempenho do(a) Discente</h1>
                ...
                <div class="sw sw-theme-basic sw-justified">
                    <div class="tab-content">
                        <div class="tab-pane" style="display: block">
                            <form class="needs-validation" novalidate id="supervisorForm" name="supervisorForm" action="supervisorController" method="post">
                                <div class="form-outline mb-3" id="textAreaDiv">
                                    <label class="form-label" for="textAvaliacao">Avaliação sobre o Desempenho do(a) Discente durante o Estágio</label>
                                    <textarea class="form-control" id="textAvaliacao" name="textAvaliacao" required></textarea>
                                    <div class="valid-feedback">
                                        Perfeito!
                                    </div>
                                    <div class="invalid-feedback">
                                        Ops! Informe uma Avaliação sobre o Desempenho do(a) Discente durante o Estágio.
                                    </div>
                                </div>
                                <div role="toolbar" style="text-align: right">
                                    <button class="btn btn-primary" type="submit" id="submitButtonSupervisorAvaliacao" name="submitButtonSupervisorAvaliacao" value="avaliacao">Enviar</button>
                                </div>
                            </form>
                        </div>
                    </div>
